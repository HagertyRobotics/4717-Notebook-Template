...
\whatsnext{
\begin{itemize}
    \item Complete the timeline
    \item We will continue to strategize throughout the year with scoring, and other parts of autonomous and design for the robot. For now, we will focus on getting ready for our first scrimmage match. 
\end{itemize} 
}
