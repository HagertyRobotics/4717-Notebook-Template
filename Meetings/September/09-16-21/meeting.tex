...
\whatsnext{
\begin{itemize}
    \item Team photos of the FLL kids, next meeting ( September, Friday the 17th), game release post.
    \item Print new wheel pulleys
    \item Buy and cut new shafts to the right length
    \item Rebuild wheel assemblies with new pulleys and shafts
    \item Ask hardware to swap the motors
    \item Finish Tele-Op
\end{itemize} 
}
