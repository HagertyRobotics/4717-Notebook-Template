...
\whatsnext{
\begin{itemize}
    \item Finishing the templates, and then with Annika's help, beginning to design them for specific team members.
    \item Test intake, fix intake and Thread Churros
    \item I hope to finish my mind map and working with the female members of the team for FIRST Ladies
    \item put teflon tape on all bearings
    \item test intake with sweeper
\end{itemize} 
}