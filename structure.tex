...
%\setlength{\cftfigurenumwidth}{3em} % Memoir way of doing width.  Small space in list of figures table
...
%\usepackage[bg=print, layout=false]{dnd}
\usepackage{geometry}
    \geometry{
...
%
% Reset chapter numbers for each part
%
%\makeatletter
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% reset section numbers on each part
%
\makeatletter
